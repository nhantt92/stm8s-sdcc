/*
  ...
  * @version V1
  * @date    30-August-2017
  * @brief   This file contains all HW registers definitions and memory mapping for 
  (STM8S105) || defined(STM8S005) || defined(STM8S103) || defined(STM8S003) ||
  defined(STM8S903) || defined(STM8AF626x) || defined(STM8AF622x)*/
/* Define to prevent recursive inclusion -------------------------------------*/
#ifndef __STM8S_H
#define __STM8S_H

/* Define SDCC compiler */
#if defined(SDCC)
 #define _SDCC_
#else
...
/*Define External High Speed oscillator (HSE)*/

#define HSE_VALUE ((uint32_t)16000000) /* Value of the External oscillator in Hz*/

/*Define Device on-chip RC oscllator frequencies*/
...
/*ADC1_Registers_Bits_Definition*/
...
#endif /* __STM8S_H */
/************************ nhantt****/
/************************ (C) Edit from STMicroelectronics *****END OF FILE****/
